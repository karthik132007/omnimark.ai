...
def analyze_session_cheating(student_answers, threshold=0.82, min_word_count=25, max_pairs_to_check=None):
    ...
    # Use a slightly larger eps (0.45) for multi-signal distance (corresponds to score >= 0.55)
    cluster_source = cluster_answers(candidates, eps=0.45, min_samples=2, distance_matrix=dist_matrix)
